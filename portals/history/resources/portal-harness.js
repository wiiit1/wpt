...
window.onload = async () => {
  ...
  // would be done with replacement even without being in a portal context,
  // which causes some of these tests to pass trivially. We wait for the
  // next task before navigating to avoid this.
